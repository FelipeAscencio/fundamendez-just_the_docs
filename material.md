...
Acá vas a encontrar el material de la cursada organizado por categoría.

> Grabaciones de clases: [link](https://docs.google.com/spreadsheets/d/1NdsaiVDjciOK13GosiEGOM7k3oinXTkOKl_Jmt4DNVI/edit?usp=sharing)

## Apuntes

<details>
  <summary><b>Ver apuntes</b></summary>
  <ul>
    <li><a href="{{ '/assets/material/apuntes/1_Introducción_a_la_programación.pdf' | relative_url }}" target="_blank" rel="noopener">1. Introducción a la Programación</a></li>
    <li><a href="{{ '/assets/material/apuntes/2_Introducción_al_Lenguaje_C.pdf' | relative_url }}" target="_blank" rel="noopener">2. Introducción al Lenguaje C</a></li>
    <li><a href="{{ '/assets/material/apuntes/3_Introducción_a_la_Modularización.pdf' | relative_url }}" target="_blank" rel="noopener">3. Introducción a la modularización</a></li>
    <li><a href="{{ '/assets/material/apuntes/4_Introducción_a_los_arreglos_y_punteros.pdf' | relative_url }}" target="_blank" rel="noopener">4. Introducción a los arreglos y punteros</a></li>
    <li><a href="{{ '/assets/material/apuntes/5_Strings.pdf' | relative_url }}" target="_blank" rel="noopener">5. Strings</a></li>
    <li><a href="{{ '/assets/material/apuntes/6_Operaciones_con_arreglos_y_listas.pdf' | relative_url }}" target="_blank" rel="noopener">6. Operaciones con arreglos y listas</a></li>
    <li><a href="{{ '/assets/material/apuntes/7_Debugging.pdf' | relative_url }}" target="_blank" rel="noopener">7. Debugging</a></li>
    <li><a href="{{ '/assets/material/apuntes/8_MakeFile.pdf' | relative_url }}" target="_blank" rel="noopener">8. Makefile</a></li>
    <li><a href="{{ '/assets/material/apuntes/9_Lenguaje_C_Avanzado.pdf' | relative_url }}" target="_blank" rel="noopener">9. Lenguaje C avanzado</a></li>
  </ul>
</details>
...
<details>
  ...
  <ul>
    ...
    <li><a href="{{ '/assets/material/trabajos_practicos/tp1.zip' | relative_url }}" target="_blank" rel="noopener">Trabajo práctico 1</a></li>
    <li><a href="{{ '/assets/material/trabajos_practicos/tp2.zip' | relative_url }}" target="_blank" rel="noopener">Trabajo práctico 2</a></li>
  </ul>
